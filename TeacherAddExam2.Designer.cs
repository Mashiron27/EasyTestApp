...
namespace EasyTestApp
{
	partial class TeacherAddExam2
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Add another question";
			...
			this.button2.Text = "Add another choice";
			...
			this.label1.Text = "Fill in your question:";
			// 
			// label2
			// 
			...
			this.label2.Location = new System.Drawing.Point(287, 163);
			this.label2.Name = "label2";
			this.label2.Size = new System.Drawing.Size(108, 20);
			this.label2.TabIndex = 19;
			this.label2.Text = "Add choice:";
			// 
			// TeacherAddExam2
			// 
